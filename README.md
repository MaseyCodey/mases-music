...
Never commit `.env`, `data/`, uploaded audio, or the SQLite database. Production requires HTTPS, `NODE_ENV=production`, the exact public URL in `APP_ORIGIN`, and persistent storage for `data/`.
